...
$.fn.bic_calendar = function(options) {
    ...
    this.each(function() {
        ...
        function showCalendar() {
            ...
            var nextMonthButton = $('<td><a href="#" class="button-month-next"><i class="fas fa-long-arrow-alt-right fa-lg"></i></a></td>');
            //event
            ...
            var previousMonthButton = $('<td><a href="#" class="button-month-previous"><i class="fas fa-long-arrow-alt-left fa-lg"></i></a></td>');
            //event
            ...
            var nextYearButton = $('<td><a href="#" class="button-year-next"><i class="fas fa-long-arrow-alt-right fa-lg"></i></a></td>');
            //event
            ...
            var previousYearButton = $('<td><a href="#" class="button-year-previous"><i class="fas fa-long-arrow-alt-left fa-lg"></i></a></td>');
            //event
